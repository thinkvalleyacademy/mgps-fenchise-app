...
public class ClassScheduleService {
    ...
    public List<ClassScheduleDTO> getSchedules(String className, String session) {
        return repository.findByClassNameAndAcademicSession(className, session)
                .stream()
                .map(this::toDTO)
    ...
    public void duplicateSchedule(DuplicateScheduleRequest request) {
        List<ClassSchedule> sourceSchedules = repository.findByClassNameAndAcademicSession(
                request.getSourceClassName(), request.getSourceSession());
