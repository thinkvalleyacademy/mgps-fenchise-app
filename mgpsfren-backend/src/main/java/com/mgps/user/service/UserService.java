...
public class UserService {
    ...
    // Kept for tests constructed before TenantGuard existed; delegates with a
    // default (non-null) guard rather than silently disabling cross-tenant checks.
    public UserService(AppUserRepository appUserRepository, PasswordEncoder passwordEncoder, JwtService jwtService,
        ...
        this(appUserRepository, passwordEncoder, jwtService, tokenRevocationService, schoolRepository,
            tenantExecutionService, activityLogService, null);
    }
